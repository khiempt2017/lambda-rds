...
return array(
    ...
    'JA' => [
        ...
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC' => '測定時に測定姿勢ガイド、カフぴったり巻、体動のエラーが検知された場合に表示。',
    ...
    'EN' => [
        ...
        // 改造BP_APP_DEV-1113 2019.09.27 QuangKK ---->
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT_DESC_A_1' => 'An irregular rhythm was detected two or more',
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT_DESC_A_2' => 'times during a measurement.',
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT_DESC_B_1' => 'An irregular rhythm was detected two or more times during a',
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT_DESC_B_2' => 'measurement.',
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_A_1' => 'Appears when an error in Positioning Indicator,',
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_A_2' => 'Cuff Wrap Guide, or Body Movement is detected ',
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_A_3' => 'during the measurement.',
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_B_1' => 'Appears when an error in Positioning Indicator,  Cuff Wrap Guide, or',
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_B_2' => 'Body Movement is detected during the measurement.',
        // BP_APP_DEV-1113 2019.09.27 <----
        'PDF_WEEK_HINT_AFIB' => 'Afib',
        'PDF_WEEK_HINT_AFIB_DESC_1' => 'Appears if Atrial fibrillation (Afib) was detected during the Afib',
        'PDF_WEEK_HINT_AFIB_DESC_2' => 'mode measurement.',
    ...
    'ZH' => [
        ...
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC' => '測量過程中若偵測到「測量高度指引」、「壓脈帶著裝確認」或「身體晃動檢測」有誤，就會顯示。',
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT' => '不規則脈波',
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT_DESC_1' => '測量過程中偵測到二或多次不規則脈波時就會顯示。',
        'PDF_WEEK_HINT_AFIB' => 'Afib',
        'PDF_WEEK_HINT_AFIB_DESC_1' => '在 Afib 模式中測量過程中，偵測到 Afib 時就會顯示。',
        'PDF_WEEK_HINT_EXCERCISE' => '運動',
        'PDF_WEEK_HINT_LACK_OF_EXCERCISE' => '運動不足',
        ...
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_1' => '測量過程中若偵測到「測量高度指引」、「壓脈帶著',
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_2' => '裝確認」或「身體晃動檢測」有誤，就會顯示。',
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_B_1' => '測量過程中若偵測到「測量高度指引」、「壓脈帶著裝確認」或',
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_B_2' => '「身體晃動檢測」有誤，就會顯示。',
        'PDF_WEEK_DATE' => '日期',
        'PDF_WEEK_TIME' => '測量時間',
        'PDF_WEEK_DI' => '測量狀態',
        'PDF_WEEK_MED' => '服藥',
    ...
    'ZH-HANS' => [
        ...
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC' => '在测量过程中检测到手腕位置、袖带佩戴自检或误动作提示错误时显示。',
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT' => '不规则脉波',
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT_DESC_1' => '在测量过程中两次或多次检测到脉波间隔不规则时显示。',
        'PDF_WEEK_HINT_AFIB' => 'Afib',
        'PDF_WEEK_HINT_AFIB_DESC_1' => '在Afib 模式下测量时，检测到 Afib 时显示。',
        ...
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_1' => '在测量过程中检测到手腕位置、袖带佩戴自检或误动',
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_2' => '作提示错误时显示。',
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_B_1' => '在测量过程中检测到手腕位置、袖带佩戴自检或误动作提示错误时',
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_B_2' => '显示。',
        'PDF_WEEK_DATE' => '日期',
        'PDF_WEEK_TIME' => '测量时间',
        'PDF_WEEK_DI' => '测量状态',
        'PDF_WEEK_MED' => '服药',
    ...
    'KO' => [
        ...
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC' => '측정 시에 측정 자세 가이드, 커프 착용 가이드, 체동(*움직임)의 에러가 감지되는 경우에 표시',
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT' => '북규칙맥파',
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT_DESC_1' => '측정 중에 맥파의 간격이 불규칙한 상태를 2회 이상',
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT_DESC_2' => '감지할 경우에 표시됩니다.',
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT_DESC_B_1' => '측정 중에 맥파의 간격이 불규칙한 상태를 2회 이상 감지할 경우에',
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT_DESC_B_2' => '표시됩니다.',
        'PDF_WEEK_HINT_AFIB' => 'Afib',
        'PDF_WEEK_HINT_AFIB_DESC' => 'Afib 모드로 측정 시에 Afib 이 감지 되면 표시됩니다.',
        ...
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_1' => '측정 도중 측정 자세 지시기, 커프 감기 가이드 또는',
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_2' => '신체 활동에 오류가 감지되는 경우 나타납니다.',
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_B_1' => '측정 도중 측정 자세 지시기, 커프 감기 가이드 또는 신체 활동에',
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_B_2' => '오류가 감지되는 경우 나타납니다.',
        'PDF_WEEK_DATE' => '일자',
        'PDF_WEEK_TIME' => '측정시간',
        'PDF_WEEK_DI' => '측정 상태',
        'PDF_WEEK_MED' => '복약',
    ...
    'DE' => [
        ...
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC' => 'Konnte nicht richtig gemessen werden.',
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT' => 'Unregelmäßiger Herzschlag',
        // 改造BP_APP_DEV-1113 2019.09.27 QuangKK ---->
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT_DESC_A_1' => 'Während einer Messung wurde zweimal oder',
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT_DESC_A_2' => 'öfter ein unregelmäßiger Rhythmus erkannt.',
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT_DESC_B_1' => 'Während einer Messung wurde zweimal oder öfter ein',
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT_DESC_B_2' => 'unregelmäßiger Rhythmus erkannt.',
        // BP_APP_DEV-1113 2019.09.27 <----
        'PDF_WEEK_HINT_AFIB' => 'AFib',
        'PDF_WEEK_HINT_AFIB_DESC_1' => 'Wird angezeigt, wenn Vorhofflimmern (Afib) während der',
        'PDF_WEEK_HINT_AFIB_DESC_2' => ' Messung im Afib-modus erkannt wurde.',
        ...
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_A_1' => 'Wird angezeigt, wenn ein Fehler in der Positionierungsanzeige, in der Manschettensitzkontrolle oder Körperbewegungen',
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_A_2' => ' während der Messung festgestellt werden.',
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_B_1' => 'Wird angezeigt, wenn ein Fehler in der Positionierungsanzeige,',
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_B_2' => 'in der Manschettensitzkontrolle oder Körperbewegungen während',
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_B_3' => 'der Messung festgestellt werden.',
        'PDF_WEEK_DATE' => 'Datum',
        'PDF_WEEK_TIME' => 'Zeit',
        'PDF_WEEK_DI' => 'E.D.',
        'PDF_WEEK_MED' => 'Med.',
    ...
    'FR' => [
        ...
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC' => "S'affiche lorsque l'erreur Indicateur de position, Guide d'enroulement du brassard ou Mouvement corporel est détectée lors de la mesure.",
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT' => 'Pulsations cardiaques irrégulières',
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT_DESC_1' => 'Un rythme irrégulier a été détecté à deux',
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT_DESC_2' => 'reprises ou plus pendant une mesure.',
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT_DESC_B_1' => 'Un rythme irrégulier a été détecté à deux reprises ou plus',
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT_DESC_B_2' => 'pendant une mesure.',
        'PDF_WEEK_HINT_AFIB' => 'Afib',
        'PDF_WEEK_HINT_AFIB_DESC_1' => "S'affiche si fibrillation auriculaire (Afib) a été détecté lors",
        'PDF_WEEK_HINT_AFIB_DESC_2' => " d'une mesure en mode Afib.",
        ...
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_1' => "S'affiche lorsque l'erreur Indicateur de position, Guide d'enroulement",
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_2' => 'du brassard ou Mouvement corporel est détectée lors de la mesure.',
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_B_1' => "S'affiche lorsque l'erreur Indicateur de position, Guide",
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_B_2' => "d'enroulement du brassard ou Mouvement corporel",
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_B_3' => 'est détectée lors de la mesure.',
        'PDF_WEEK_DATE' => 'Date',
        'PDF_WEEK_TIME' => 'Heure',
        'PDF_WEEK_DI' => 'I.D.',
        'PDF_WEEK_MED' => 'Tra.',
    ...
    'IT' => [
        ...
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_B_1' => 'Visualizzato quando durante la misurazione viene rilevato un errore',
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_B_2' => 'in Indicatore di posizionamento, Guida posizionamento bracciale o ',
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_B_3' => 'Sensore di movimento.',
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT' => 'Battito cardiaco irregolare',
        // 改造BP_APP_DEV-1103 2019.09.27 QuangKK ---->
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_A_1' => 'Visualizzato quando durante la misurazione',
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_A_2' => 'viene rilevato un errore in Indicatore di',
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_A_3' => 'posizionamento, Guida posizionamento bracciale',
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_A_4' => 'o Sensore di movimento.',
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT_DESC_A_1' => 'È stato rilevato un ritmo irregolare due o più',
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT_DESC_A_2' => 'volte durante una misurazione.',
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT_DESC_B_1' => 'È stato rilevato un ritmo irregolare due o più volte durante una',
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT_DESC_B_2' => 'misurazione.',
        // BP_APP_DEV-1059 2018.09.27 <----
        'PDF_WEEK_HINT_AFIB' => 'Afib',
        'PDF_WEEK_HINT_AFIB_DESC_1' => 'Visualizzato se è stata rilevata una fibrillazione atriale (Afib)',
        'PDF_WEEK_HINT_AFIB_DESC_2' => 'durante la misurazione in modalità Afib.',
    ...
    'ES' => [
        ...
        // 改造BP_APP_DEV-1059 2019.09.05 TanND ---->
        // 改造BP_APP_DEV-2678 2023.06.01 TrungNT ---->
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC' => 'Aparece cuando se detecta un error en el indicador de posición, en la guía de ajuste del brazalete o cuando se detecta movimiento corporal durante la medición.',
        // 改造BP_APP_DEV-2678 2023.06.01 <----
        // BP_APP_DEV-1059 2019.09.05 <----
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT' => 'Latido arrítmico',
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT_DESC_1' => 'Se ha detectado un ritmo irregular en dos o más',
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT_DESC_2' => 'ocasiones durante una medición.',
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT_DESC_B_1' => 'Se ha detectado un ritmo irregular en dos o más ocasiones',
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT_DESC_B_2' => 'durante una medición.',
        'PDF_WEEK_HINT_AFIB' => 'Afib',
        // 改造BP_APP_DEV-2678 2023.06.01 TrungNT ---->
        'PDF_WEEK_HINT_AFIB_DESC_1' => 'Aparece si se detecta fibrilación auricular (Afib) durante una ',
        // 改造BP_APP_DEV-2678 2023.06.01 <----
        'PDF_WEEK_HINT_AFIB_DESC_2' => 'medición en modo de Afib.',
        ...
        // BP_APP_DEV-1059 2019.09.17 <----
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_1' => 'Aparece cuando se detecta un error en el',
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_2' => 'indicador de posición, en la guía de ajuste del',
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_3' => 'brazalete o cuando se detecta movimiento',
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_4' => 'corporal durante la medición.',
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_B_1' => 'Aparece cuando se detecta un error en el indicador de posición,',
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_B_2' => 'en la guía de ajuste del brazalete o cuando se detecta',
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_B_3' => 'movimiento corporal durante la medición.',
    ...
    'NL' => [
        ...
        // 改造BP_APP_DEV-1059 2019.09.05 TanND ---->
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC' => 'Verschijnt wanneer tijdens de meting een fout wordt gedetecteerd in de Positie-indicator, Manchetinstelling of Lichaamsbeweging.',
        // BP_APP_DEV-1059 2019.09.05 <----
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT' => 'Onregelmatige hartslag',
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT_DESC_1' => 'Er is twee keer of meer een onregelmatig ',
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT_DESC_2' => 'ritme waargenomen tijdens een meting.',
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT_DESC_B_1' => 'Er is twee keer of meer een onregelmatig ritme waargenomen',
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT_DESC_B_2' => 'tijdens een meting.',
        'PDF_WEEK_HINT_AFIB' => 'Afib',
        'PDF_WEEK_HINT_AFIB_DESC_1' => 'Verschijnt als atriumfibrillatie (Afib) wordt',
        'PDF_WEEK_HINT_AFIB_DESC_2' => 'gedetecteerd tijdens de Afib-modusmeting.',
        ...
        // BP_APP_DEV-1059 2019.09.17 <----
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_1' => 'Verschijnt wanneer tijdens de meting een fout',
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_2' => 'wordt gedetecteerd in de Positie-indicator,',
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_3' => 'Manchetinstelling of Lichaamsbeweging.',
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_B_1' => 'Verschijnt wanneer tijdens de meting een fout wordt',
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_B_2' => 'gedetecteerd in de Positie-indicator, Manchetinstelling of',
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_B_3' => 'Lichaamsbeweging.',
        'PDF_WEEK_DATE' => 'Datum',
        'PDF_WEEK_TIME' => 'Tijd',
        // 改造BP_APP_DEV-1059 2019.09.05 TanND ---->
        'PDF_WEEK_DI' => 'W.I.',
    ...
    'PL' => [
        ...
        // 改造BP_APP_DEV-1059 2019.09.05 TanND ---->
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC' => 'Wyświetlana, gdy podczas pomiaru wykryto błąd w funkcji Wskaźnik pozycji, Instrukcja dotycząca mankietu lub Ruch ciała.',
        // BP_APP_DEV-1059 2019.09.05 <----
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT' => 'Nieregularne bicie serca',
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT_DESC_1' => 'Pojawia się w razie wykrycia nieregularnego ',
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT_DESC_2' => 'rytmu co najmniej dwukrotnie podczas pomiaru.',
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT_DESC_B_1' => 'Pojawia się w razie wykrycia nieregularnego rytmu co najmniej',
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT_DESC_B_2' => 'dwukrotnie podczas pomiaru.',
        'PDF_WEEK_HINT_AFIB' => 'Afib',
        'PDF_WEEK_HINT_AFIB_DESC_1' => 'Wyświetlana w przypadku wykrycia migotanie przedsionków',
        'PDF_WEEK_HINT_AFIB_DESC_2' => '(Afib) podczas pomiaru w trybie wskaźnika Afib.',
        ...
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_MODE_A_1' => 'Wyświetlana, gdy podczas pomiaru wykryto',
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_MODE_A_2' => 'błąd w funkcji Wskaźnik pozycji, Instrukcja',
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_MODE_A_3' => 'dotycząca mankietu lub Ruch ciała.',
        'PDF_WEEK_DATE' => 'Data',
        'PDF_WEEK_TIME' => 'Czas',
        // 改造BP_APP_DEV-1059 2019.09.05 TanND ---->
        'PDF_WEEK_DI' => 'W.I.',
    ...
    'SV' => [
        ...
        // 改造BP_APP_DEV-1059 2019.09.05 TanND ---->
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC' => 'Visas när fel har uppstått som kopplas till positioneringsindikatorn, manschettanpassning eller om kroppen rör sig under mätningen.',
        // BP_APP_DEV-1059 2019.09.05 <----
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT' => 'Oregelbunden hjärtrytm',
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT_DESC_1' => 'En oregelbunden rytm upptäcks två eller ',
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT_DESC_2' => 'fler gånger under en mätning.',
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT_DESC_B_1' => 'En oregelbunden rytm upptäcks två eller fler gånger under',
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT_DESC_B_2' => 'en mätning.',
        'PDF_WEEK_HINT_AFIB' => 'Afib',
        'PDF_WEEK_HINT_AFIB_DESC_1' => 'Visas om förmaksflimmer (Afib) upptäcktes under',
        'PDF_WEEK_HINT_AFIB_DESC_2' => 'mätning i Afib-läge',
        ...
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_B_1' => 'Visas när fel har uppstått som kopplas till',
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_B_2' => 'positioneringsindikatorn, manschettanpassning',
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_B_3' => 'eller om kroppen rör sig under mätningen.',
        'PDF_WEEK_DATE' => 'Datum',
        'PDF_WEEK_TIME' => 'Tid',
        // 改造BP_APP_DEV-1059 2019.09.05 TanND ---->
        'PDF_WEEK_DI' => 'U.I.',
    ...
    'TR' => [
        ...
        // 改造BP_APP_DEV-1059 2019.09.05 TanND ---->
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC' => 'Ölçüm sırasında Konumlandırma Göstergesinde, Bileklik Kılavuzunda veya Vücut Hareketinde bir hata algılandığında görünür.',
        // BP_APP_DEV-1059 2019.09.05 <----
        ...
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT_DESC_A_1' => 'Bir ölçüm sırasında iki kez veya daha fazla',
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT_DESC_A_2' => 'düzensiz ritm tespit edildi.',
        'PDF_WEEK_HINT_AFIB' => 'Afib',
        'PDF_WEEK_HINT_AFIB_DESC_1' => 'Afib modunda ölçüm sırasında atrial fibrilasyon (Afib)',
        'PDF_WEEK_HINT_AFIB_DESC_2' => 'algılandıysa görünür.',
        ...
        // BP_APP_DEV-1059 2019.09.17 <----
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_A_1' => 'Ölçüm sırasında Konumlandırma Göstergesinde,',
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_A_2' => 'Bileklik Kılavuzunda veya Vücut Hareketinde bir',
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_A_3' => 'hata algılandığında görünür.',
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_B_1' => 'Ölçüm sırasında Konumlandırma Göstergesinde,Bileklik',
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_B_2' => 'Kılavuzunda veya Vücut Hareketinde bir hata algılandığında',
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_B_3' => 'görünür.',
        'PDF_WEEK_DATE' => 'Tarih',
        'PDF_WEEK_TIME' => 'Saat',
        // 改造BP_APP_DEV-1059 2019.09.05 TanND ---->
        'PDF_WEEK_DI' => 'A.B.',
    ...
    'PT' => [
        ...
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT_DESC_1' => 'Foi detectado ritmo cardíaco irregular duas ou ',
        // 改造BP_APP_DEV-2678 2023.06.01 <----
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT_DESC_2' => 'mais vezes durante uma medição.',
        // 改造BP_APP_DEV-2678 2023.06.01 TrungNT ---->
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT_DESC_B_1' => 'Foi detectado ritmo cardíaco irregular duas ou mais vezes ',
        // 改造BP_APP_DEV-2678 2023.06.01 <----Z
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT_DESC_B_2' => 'durante uma medição.',
        'PDF_WEEK_HINT_AFIB' => 'Afib',
        'PDF_WEEK_HINT_AFIB_DESC_1' => 'É exibido ao detectar fibrilação atrial (Afib) durante a medição',
        'PDF_WEEK_HINT_AFIB_DESC_2' => 'no modo de Afib.',
    ...
    'VI' => [
        ...
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT_DESC_A_1' => 'Một nhịp bất thường đã được phát hiện hai hoặc ',
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT_DESC_A_2' => 'nhiều lần trong quá trình đo.',
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT_DESC_B_1' => 'Một nhịp bất thường đã được phát hiện hai hoặc nhiều lần ',
        'PDF_WEEK_HINT_IRREGULAR_HEARTBEAT_DESC_B_2' => 'trong quá trình đo.',
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_A_1' => 'Xuất hiện khi phát hiện lỗi trong Chỉ báo Định vị,',
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_A_2' => 'Hướng dẫn Quấn vòng bít hoặc Chuyển động ',
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_A_3' => 'của Cơ thể trong quá trình đo.',
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_B_1' => 'Xuất hiện khi phát hiện lỗi trong Chỉ báo Định vị, Hướng dẫn ',
        'PDF_WEEK_HINT_MEASUREMENT_ERROR_DESC_B_2' => 'Quấn vòng bít, hoặc Chuyển động của Cơ thể trong quá trình đo.',
        'PDF_WEEK_HINT_AFIB' => 'Afib',
        'PDF_WEEK_HINT_AFIB_DESC_1' => 'Xuất hiện nếu Rung tâm nhĩ (Afib) được phát hiện trong quá trình đo ở ',
        'PDF_WEEK_HINT_AFIB_DESC_2' => 'chế độ Afib.',
